...
import com.app.khajaghar.data.model.*
import com.app.khajaghar.databinding.ActivityCartBinding
import com.app.khajaghar.databinding.BottomSheetDeliveryLocationBinding
import com.app.khajaghar.databinding.BottomSheetShopInfoBinding
import com.app.khajaghar.ui.payment.PaymentActivity
...
class CartActivity : AppCompatActivity() {
    ...
    private fun verifyOrder(){
        ...
        cart.forEach {
            listCartOrderItems.add(CartOrderItems(FoodItem(it.id.toInt()), it.price, it.quantity))
        }
